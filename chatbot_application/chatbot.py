...
import numpy as np
import re
from chatbot_application import Attention_Layer
from tensorflow.keras.preprocessing.sequence import pad_sequences
# import example_file as ef

with open('D:\\python files\\webapp\\chatbot_application\\dic.pkl', 'rb') as f:
    vocab = pickle.load(f)
with open('D:\\python files\\webapp\\chatbot_application\\inv.pkl', 'rb') as f:
...
attn_layer = Attention_Layer.AttentionLayer()
model = load_model('D:\\python files\\webapp\\chatbot_application\\chatbot.h5', custom_objects={'AttentionLayer' : attn_layer})
